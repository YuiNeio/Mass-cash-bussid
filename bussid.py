...
record = [{'Key': {'sourceCity': 'MLG', 'destinationCity': 'SBY', 'routePassed': ['SBY', 'MLG'], 'activityRewards': None}, 'Value': 2000000},
          ...
          {'Key': {'sourceCity': 'MLG', 'destinationCity': 'JKT', 'routePassed': ['JKT', 'MLG'], 'activityRewards': None}, 'Value': 3},
          {'Key': {'sourceCity': 'JKT', 'destinationCity': 'P_Merak', 'routePassed': ['P_Merak', 'JKT'], 'activityRewards': None}, 'Value': 45}]
          
auth = input('Auth: ')
password = input('Password (yui): ')
headers = {'User-Agent': 'UnityEngine-Unity; Version: 2018.4.26f1',
           ...
           'Yui-Password': password}  # Adding password to the headers
